module.exports = {
  Admins: ["722893072580476978", "686364961504624661"], // Admins of the bot, I don't know what this do. -Darren.
  ExpressServer: true, // If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || ">", // Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/f3mfH59pEf", // Support Server Link
  Token: process.env.Token || "OTk3NTMzNTg0NTc3NTQwMTQ2.G95cTP.FsQxwRuhPtH7mAaSQJWDkJ1ituG3BBAGnFYXco", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "997533584577540146", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "y5cPOFeXmBkC2RbcSwUHGJfBVHXl2DWu", // Discord Client Secret
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "8571b2c8b97a42938acdafa933ae1886", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "6cc17a8187044e199aed635df2df4fd3", // Spotify Client Secret
  },
};
